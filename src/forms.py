...
class ActivityForm(FlaskForm):
    ...
    registration_mode = SelectField('报名模式', choices=[('individual', '个人报名'), ('team', '团队报名')], default='individual')
    team_max_members = IntegerField('每队最大人数', validators=[Optional(), NumberRange(min=1, max=50, message='每队人数需在1-50之间')], default=1)
    team_max_count = IntegerField('最大参赛队伍数', validators=[Optional(), NumberRange(min=0, message='队伍数不能为负数')], default=0)
